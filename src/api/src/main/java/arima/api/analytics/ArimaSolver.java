...
public final class ArimaSolver {
    ...
    @AllArgsConstructor
    private static class DifferentiationResult {
        final double[] dataStationary;
        final double meanStationary;
        final boolean hasSeasonalI;
        final boolean hasNonSeasonalI;
    }
}
